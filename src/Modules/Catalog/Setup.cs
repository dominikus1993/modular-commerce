...
public static class Setup
{
    ...
    {
        yield return new Product(new ProductId(Guid.CreateVersion7()), new ProductName("nivea"), new ProductDescription("nivea cream"),
            new ProductPrice(new Price(10m), new Price(5m)), new AvailableQuantity(10), [new Tag("cream"), new Tag("face")], []);
        yield return new Product(new ProductId(Guid.CreateVersion7()), new ProductName("dove"), new ProductDescription("dove soap"), new ProductPrice(new Price(5m), new Price(2m)),
        ...
        yield return new Product(new ProductId(Guid.CreateVersion7()), new ProductName("colgate"), new ProductDescription("colgate toothpaste"), new ProductPrice(new Price(3m), new Price(1m)), new AvailableQuantity(30),
            [new Tag("toothpaste"), new Tag("teeth")], [new ProductImage(new Uri("/images/catalog/408787_360_350_1709189190.png"), "dove soap")]);
        yield return new Product(new ProductId(Guid.CreateVersion7()), new ProductName("dettol"), new ProductDescription("dettol handwash"), new ProductPrice(new Price(4m), new Price(2m)), new AvailableQuantity(40),
            [new Tag("handwash"), new Tag("hands")], [new ProductImage(new Uri("/images/catalog/408787_360_350_1709189190.png"), "dove soap")]);
        yield return new Product(new ProductId(Guid.CreateVersion7()), new ProductName("tide"), new ProductDescription("tide detergent"), new ProductPrice(new Price(8m), new Price(4m)), new AvailableQuantity(50),
            [new Tag("detergent"), new Tag("clothes")], [new ProductImage(new Uri("/images/catalog/408787_360_350_1709189190.png"), "dove soap")]);
        yield return new Product(new ProductId(Guid.CreateVersion7()), new ProductName("pepsi"), new ProductDescription("pepsi drink"), new ProductPrice(new Price(2m), new Price(1m)), new AvailableQuantity(60),
            [new Tag("drink"), new Tag("beverage")], [new ProductImage(new Uri("/images/catalog/408787_360_350_1709189190.png"), "dove soap")]);
        yield return new Product(new ProductId(Guid.CreateVersion7()), new ProductName("lays"), new ProductDescription("lays chips"), new ProductPrice(new Price(1m), new Price(0.5m)), new AvailableQuantity(70),
            [new Tag("chips"), new Tag("snacks")], [new ProductImage(new Uri("/images/catalog/408787_360_350_1709189190.png"), "dove soap")]);
        yield return new Product(new ProductId(Guid.CreateVersion7()), new ProductName("kitkat"), new ProductDescription("kitkat chocolate"), new ProductPrice(new Price(3m), new Price(1.5m)), new AvailableQuantity(80),
            [new Tag("snacks"), new Tag("chocolate")], [new ProductImage(new Uri("/images/catalog/408787_360_350_1709189190.png"), "dove soap")]);
        yield return new Product(new ProductId(Guid.CreateVersion7()), new ProductName("dairy milk"), new ProductDescription("dairy milk chocolate"), new ProductPrice(new Price(2.99m)), new AvailableQuantity(90),
        ...
        yield return new Product(new ProductId(Guid.CreateVersion7()), new ProductName("sprite"), new ProductDescription("sprite drink"), new ProductPrice(new Price(1.21m)), new AvailableQuantity(100),
            [new Tag("drink")], [new ProductImage(new Uri("/images/catalog/408787_360_350_1709189190.png"), "dove soap")]);
        yield return new Product(new ProductId(Guid.CreateVersion7()), new ProductName("pepsi"), new ProductDescription("pepsi cola"), new ProductPrice(new Price(1.25m)), new AvailableQuantity(100),
            [new Tag("drink")], [new ProductImage(new Uri("/images/catalog/408787_360_350_1709189190.png"), "dove soap")]);
        yield return new Product(new ProductId(Guid.CreateVersion7()), new ProductName("nivea"), new ProductDescription("nivea soap"), new ProductPrice(new Price(5m), new Price(1m)),
            new AvailableQuantity(20), [new Tag("soap"), new Tag("body")], [new ProductImage(new Uri("/images/catalog/408787_360_350_1709189190.png"), "dove soap")]);
        yield return new Product(new ProductId(Guid.CreateVersion7()), new ProductName("isana"), new ProductDescription("isana soap"), new ProductPrice(new Price(5m), new Price(1m)),
            new AvailableQuantity(20), [new Tag("soap"), new Tag("body")], [new ProductImage(new Uri("/images/catalog/408787_360_350_1709189190.png"), "dove soap")]);
        yield return new Product(new ProductId(Guid.CreateVersion7()), new ProductName("domol"), new ProductDescription("domol soap"), new ProductPrice(new Price(5m), new Price(1m)),
            new AvailableQuantity(20), [new Tag("soap"), new Tag("body")], [new ProductImage(new Uri("/images/catalog/408787_360_350_1709189190.png"), "dove soap")]);
